...
<?php require_once("include/nav_left.php"); ?>
        ...
        <div class="search-layout3 searchmargin" >
                        <div class="search-layout3-holder">
                            <div class="container">
                                <form id="cp-search-form2" class="bg-primary search-layout3-inner" method="POST" action="sellersearchview.php" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-xl-9 col-lg-9 col-12">
                                            <div class="search-box form-group search-input-area ">
                                                <input type="text" name="hsncode" autocomplete="off" placeholder="Search Seller by HSN/TARIFF Code..." />
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12 col-12">
                                <div class="add-layout2-left d-flex align-items-center">
                                    <div>
                                        ...
                                        <h3>Submit your enquiry on Industrial Stock Exchange</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-5 col-md-5 col-sm-12 col-12">
                                <div class="add-layout2-right d-flex align-items-center justify-content-end mb--sm">
                                    <a href="enquiry.php" class="cp-default-btn-sm-primary">Post Your Enquiry Now Click Here</a>
                                </div>
                            </div>
                        </div>

<div class="container">
    <center><h2>Available Seller</center>
	<div class="row">
...
<?php 
$prd_sql = "SELECT id, companyname, hsncode  FROM advertisement ORDER BY id DESC LIMIT 0,10";
$prd_exec = mysqli_query($conn,$prd_sql);
while ($prd_res = mysqli_fetch_array($prd_exec)) {
?>            	
                <div class="item" onclick="window.location.href='single-product.php?id=<?php echo $prd_res["id"] ?>'">
                    <div class="pad15" style="min-height: 180px;">
                        <p class="lead"><?php echo $prd_res['companyname'] ?></p>
                        <?php echo $prd_res['hsncode'] ?>
                    </div>
                </div>
<?php } ?>
            </div>
        ...
        <?php
            ...
            if ($result = $conn->query("SELECT * FROM enquiry ORDER BY id DESC"))
            {
...
<div class="col-lg-4 col-md-6 col-sm-6 col-12 menu-item">
 ...
 <?php
            ...
            // display pagination
            ?>
            <div style="font-weight: 300px; font-size: 25px; text-align: center;"><!--<b>No results to display post your enquiry now</b>-->
            <?php
