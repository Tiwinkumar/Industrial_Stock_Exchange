...
<?php require_once("include/nav_left.php"); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-9 col-lg-9 col-12">
                                            <div class="search-box form-group search-input-area ">
                                                <input type="text" autocomplete="off" name="hsncode" placeholder="Search Buyer by HSN/TARIFF Code..." />
        ...
        <!-- Search Area End Here -->
         ...
         <div class="row no-gutters" style="margin-top: 10%;">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-12 col-12">
                                <div class="add-layout2-right d-flex align-items-center justify-content-end mb--sm">
                                    <a href="adform.php" class="cp-default-btn-sm-primary">Post Your Ad Now Click Here</a>
                                </div>
                            </div>
                        </div>
<div class="container">
    <center><h2>Available Buyer</center>
    <div class="row">
        <div class="MultiCarousel" data-items="1,3,5,3" data-slide="1" id="MultiCarousel"  data-interval="1000">
            <div class="MultiCarousel-inner">
<?php 
$enq_sql = "SELECT id, name,hsncode,message FROM enquiry ORDER BY id DESC LIMIT 0,10";
$enq_exec = mysqli_query($conn,$enq_sql);
while ($enq_res = mysqli_fetch_array($enq_exec)) {
?>              
                <div class="item" onclick="window.location.href='viewproduct.php?id=<?php echo $enq_res['id']; ?>'">
                    <div class="pad15" style="min-height: 180px;">
                        <p class="lead"><?php echo $enq_res["name"]; ?></p>
                        <p><?php echo $enq_res["hsncode"]; ?></p>
                    </div>
                </div>
<?php } ?>
            </div>
        ...
        <?php
            ...
            if ($result = $conn->query("SELECT * FROM advertisement ORDER BY id DESC"))
            {
        ...
        <section class="products-layout1 bg-body s-space-default" style="background-color: #F4F6F5;">
            <div class="container">
                <div class="section-title-dark">
                    <h2>Available Seller</h2>
            ...
            ?>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 menu-item">
                        <div class="product-box item-mb zoom-gallery">
                            <div class="item-mask-wrapper" style="border:1px solid #329afc; min-height: 150px; padding:2px; cursor:pointer; " onclick="window.location.href='single-product.php?id=<?php echo $row["id"] ?>';">
                                <h3 class="short-title"><a href='single-product.php?id=<?php echo $row["id"] ?>'><?php echo $row["companyname"] ?></a>
                                </h3>
     ...
     ?>   
            ...
            // display pagination
            ?>
            <div style="font-weight: 300px; font-size: 25px; text-align: center;"><!--<b>No results to display post your ad now</b>-->
            <?php
