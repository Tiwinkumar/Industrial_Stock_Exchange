...
$sql= "SELECT * FROM advertisement ";
    ...
    if($result = mysqli_query($conn, $sql)) {
      ...
      {
        $sellercount = mysqli_num_rows($result);
        }
        else
        {
            $sellercount = 0;
...
$sql= "SELECT * FROM enquiry ";
    ...
    if($result = mysqli_query($conn, $sql)) {
      if(mysqli_num_rows($result) > 0) 
      {
        $buyercount = mysqli_num_rows($result);
        }
        else
        {
            $buyercount = 0;
        ...
        <div class="container-fluid search-layout3 search-layout3-holder">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="about.php" style="font-size: 18px;">About Us</a>
                    </li>
                    <li class="nav-item">
...
<?php require_once("include/nav_left.php"); ?>
        ...
        <section class="service-layout1 bg-accent s-space-custom2 spacing" style="margin-top: -10px;">
            <div class="container">
                <div class="section-title-dark">
                    <h2 style="text-transform: uppercase;">Raw Materials , Finish Goods , Scrap</h2>
                    
                </div>
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-6 col-12 item-mb">
                    </div>

                    <div class="col-lg-4 col-md-4 col-sm-6 col-6 item-mb">
                        <div class="service-box1 bg-body text-center">
                            
                            <h3 class="title-medium-dark mb-3">
                                <a href="buyerview.php">BUYER</a>
                            </h3>
                ...
                <div class="row">
                    <div class="col-sm-4 col-12">
                        <div class="d-md-flex justify-md-content-center counter-box text-center--md">
                            ...
                            <div>
                                <div class="counter counter-title" data-num="<?php echo $sellercount;
 ?>"><?php echo $sellercount;
 ?></div>
                                <h3 class="title-regular-light">Our Ads</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 col-12">
                        <div class="d-md-flex justify-md-content-center counter-box text-center--md">
                            ...
                            <div>
                                <div class="counter counter-title" data-num="<?php echo $buyercount;
 ?>"><?php echo $buyercount;
 ?></div>
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="d-md-flex justify-md-content-center counter-box text-center--md">
                            ...
                            <div>
                                <div class="counter counter-title" data-num="<?php echo $usercount;
 ?>"><?php echo $usercount;
 ?></div>
                                <h3 class="title-regular-light">Users</h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="bg-accent s-space-regular" id="how-it-works" style="margin-top: -50px;">
            <div class="container">
                <div class="section-title-dark">
                ...
                <ul class="process-area">
                    <li>
                        <img src="img/banner/1.png" alt="process" class="img-fluid">
                        <h3>Register your company</h3>
                                            </li>
                    <li>
                        <img src="img/banner/process1.png" alt="process" class="img-fluid">
                        <h3>Upload your Products with HSN/TARIFF Code</h3>
                       
                    </li>
                    <li>
                        <img src="img/banner/2.png" alt="process" class="img-fluid">
