...
?>                            	
                                <form method="POST" action="buyerform.php" enctype="multipart/form-data" class="contact-form">
                                    <fieldset>
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <input type="text" placeholder="Your Name" class="form-control" name="name" value="<?php echo $user_res['fname'].' '.$user_res['lname']; ?>" id="form-name" data-error="Name field is required" required readonly>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <input type="email" placeholder="Your E-mail" class="form-control" name="email" id="form-email" value="<?php echo $user_res['email']; ?>" data-error="Email field is required" required readonly>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <input type="text" placeholder="Your Mobile Number" class="form-control" name="mobile" id="form-mobile" value="<?php echo $user_res['phone']; ?>" data-error="Mobile Number field is required" required readonly>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <input type="text" placeholder="Location: City,Country" class="form-control" name="location" id="form-location" data-error="Location field is required" required>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <input type="text" placeholder="Company Name" class="form-control" name="cname" value="<?php echo $user_res['cmpname']; ?>" id="form-cname" data-error="Company Name field is required" required readonly>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="search-box form-group search-input-area ">
                                                <input type="text" name="hsncode" autocomplete="off" data-error="HSN Code field is required" class="form-control" placeholder="Search by HSN Code..." />
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <input type="text" placeholder="Price" class="form-control" name="price" id="form-price" data-error="Price field is required"  required>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <input type="text" placeholder="Quantity" class="form-control" name="quantity" id="form-quantity" data-error="Quantity field is required" required>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>                              
                                            <div class="col-12">
